...
object Constants {
    ...
    const val FIRE_BASE_CONFIG_URL = "https://kepler-6cc2c-default-rtdb.asia-southeast1.firebasedatabase.app"
    const val ID_SERVER_DEV = "https://dev-api.kepler.asia/id/"
    const val ID_SERVER_STAG = "https://stg-api.kepler.asia/id/"
    const val ID_SERVER_PRO = "https://api.kepler.asia/id/"

    const val SERVER_URL_DEV = "https://dev-api.kepler.asia/wellness/"
    const val SERVER_URL_STAG = "https://stg-api.kepler.asia/wellness/"
    const val SERVER_URL_PRO = "https://api.kepler.asia/wellness/"

    const val CHAT_SERVER_URL_DEV = "https://dev-api.kepler.asia/chat/"
    const val CHAT_SERVER_URL_STAG = "https://stg-api.kepler.asia/chat/"
    const val CHAT_SERVER_URL_PRO = "https://api.kepler.co/chat/"

    const val SOCKET_URL_DEV = "wss://dev-socket.kepler.asia/chat"
    const val SOCKET_URL_STAG = "wss://stg-socket.kepler.asia/chat"
    const val SOCKET_URL_PRO = "wss://socket.kepler.asia/chat"

    const val UPLOAD_URL_DEV = "https://dev-api.kepler.asia/file/"
    const val UPLOAD_URL_STAG = "https://stg-api.kepler.asia/file/"
    const val UPLOAD_URL_PRO = "https://api.kepler.asia/file/"
