...
class SendBookmarkUseCase @Inject constructor(private val repository: RTCBookingServiceRepository) : BaseUseCase<EventRtc,Unit>() {
    override fun execute(arg: EventRtc): Either<Exception, Unit> = repository.sendBookmark(event = arg)
}