...
class SendTipPackageUseCase @Inject constructor(private val repository: RTCLiveStreamRepository) :
    BaseUseCase<EventRtc, Unit>() {
    override fun execute(arg: EventRtc): Either<Exception, Unit> =
        repository.sendTipPackage(arg)
}