...
class GetChatMessagePCUseCase @Inject constructor(private val repository: RTCPrivateChatRepository)  : BaseUseCase<Unit, StateFlow<ChatMessage?>>() {
    override fun execute(arg: Unit): Either<Exception, StateFlow<ChatMessage?>> = repository.chatMessage()
}