...
class SendLoadMoreMessagesPCUseCase @Inject constructor(private val repository: RTCPrivateChatRepository) : BaseUseCase<EventRtc,Unit>() {
    override fun execute(arg: EventRtc): Either<Exception, Unit>  = repository.sendLoadMoreMessage(arg)
}