...
import olmo.wellness.android.ui.common.live_stream.carousel.PageData
...
fun PagerCarousel(
    ...
    state: PagerStateCarousel,
    orientation: Orientation = Orientation.Horizontal,
    offscreenLimit: Int = 2,
    content: @Composable PagerScopeCarousel.() -> Unit
) {
...
@Composable
private fun PagerStateCarousel.PrepareContent(
    offscreenLimit: Int,
    content: @Composable PagerScopeCarousel.() -> Unit
) {
    ...
    for (page in minPage..maxPage) {
        ...
        val scope = PagerScopeCarousel(this, page)
        key(pageData) {
