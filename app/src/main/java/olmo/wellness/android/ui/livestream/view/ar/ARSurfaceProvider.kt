...
import olmo.wellness.android.ui.livestream.view.ar.ARSurfaceProvider
 ...
 */
@OptIn(markerClass = arrayOf(ExperimentalUseCaseGroup::class))
class ARSurfaceProvider internal constructor(
    ...
    override fun onSurfaceRequested(request: SurfaceRequest) {
        ...
        if (surfaceTexture == null) {
            ...
            surfaceTexture!!.setOnFrameAvailableListener { it: SurfaceTexture? ->
                if (stop) {
