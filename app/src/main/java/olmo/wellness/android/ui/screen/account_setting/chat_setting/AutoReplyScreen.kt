...
import olmo.wellness.android.ui.theme.Neutral_Gray_2
...
@Composable
fun AutoReplyScreen(navController: NavController,
        ...
        Scaffold(topBar = {
            ...
            Column(
                ...
                Column(
                    ...
                    BaseEditTextInputProfile(hint = "", contentDefault = "Hello! How can I help you?", onTextChanged = {
                        textChange = it
                    }, isMiniHeight = false)
                }
